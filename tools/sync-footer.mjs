...
const STRINGS = {
  trad: {
    ...
    l_origin: "緣起故事", l_team: "義工團隊", l_videos: "影音開示", l_progress: "籌建進度",
  ...
  simp: {
    ...
    l_origin: "缘起故事", l_team: "义工团队", l_videos: "影音开示", l_progress: "筹建进度",
  ...
  en: {
    ...
    l_origin: "Our Origin", l_team: "Volunteer Team", l_videos: "Talks &amp; Videos", l_progress: "Progress",
    l_words: "In His Words", l_funds: "Use of Gifts", l_join: "Join Us",
    l_temple: "American Buddhist Fellowship", l_youtube: "YouTube Channel",
